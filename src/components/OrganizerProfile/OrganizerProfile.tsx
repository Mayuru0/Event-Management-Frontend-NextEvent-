...
import { Pencil, Camera, Save, Check, Mail, Phone, MapPin, User, Hash, Home, ShieldCheck } from "lucide-react";
...
export default function OrganizerProfile() {
  ...
  return (
    <div className="bg-[#1A1A1A] rounded-3xl md:rounded-r-3xl mt-28 ">
      {/* Hero Banner */}
      <div className="relative h-44 rounded-t-3xl md:rounded-tr-3xl overflow-hidden bg-gradient-to-br from-[#6200EE] via-[#4500B5] to-[#1C0030]">
        {/* Decorative blobs */}
        <div className="absolute -top-12 -right-12 w-56 h-56 rounded-full bg-[#00FFC2]/15 blur-3xl pointer-events-none" />
        <div className="absolute top-6 right-36 w-20 h-20 rounded-full bg-white/5 blur-xl pointer-events-none" />
        <div className="absolute -bottom-10 left-16 w-44 h-44 rounded-full bg-[#00FFC2]/8 blur-3xl pointer-events-none" />
        {/* Dot grid */}
        <div
        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold backdrop-blur-sm transition-all shadow-lg ${
              isEditing
                ? "bg-[#00FFC2] hover:bg-[#00FFC2]/90 text-black shadow-[#00FFC2]/25"
      ...
      <div className="flex items-end gap-5 -mt-14 px-6 md:px-8 relative z-10">
        ...
        >
          ...
          {profile.isVerified && (
            <div className="absolute -bottom-1.5 -right-1.5 bg-[#00FFC2] rounded-full p-1.5 border-2 border-[#1A1A1A] shadow-lg">
        ...
        {/* Quick action hint on desktop when editing */}
        {isEditing && (
          <p className="hidden sm:block text-xs text-[#00FFC2]/70 mb-4">Click photo to change</p>
        )}
      </div>
        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div>
            <div className="flex items-center gap-2.5 flex-wrap">
              <h1 className="text-2xl font-bold text-white tracking-tight">{profile.name || "Organizer Name"}</h1>
              {profile.isVerified && (
                <span className="flex items-center gap-1.5 bg-[#00FFC2]/10 border border-[#00FFC2]/25 text-[#00FFC2] text-xs font-semibold px-2.5 py-1 rounded-full">
            ...
            <div className="flex items-center gap-2.5 mt-2 flex-wrap">
              ...
              <span className="text-xs font-bold text-[#6200EE] bg-[#6200EE]/10 px-2.5 py-0.5 rounded-full border border-[#6200EE]/20 tracking-wide">
                ORGANIZER
              </span>
            </div>
          </div>
      ...
      {/* Gradient Divider */}
      <div className="mx-6 md:mx-8 h-px bg-gradient-to-r from-[#6200EE]/40 via-[#00FFC2]/15 to-transparent" />
      ...
      <div className="p-6 md:p-8 space-y-10">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-0.5 h-5 rounded-full bg-gradient-to-b from-[#6200EE] to-[#00FFC2]" />
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className={`w-full rounded-xl px-4 py-3 text-sm outline-none transition-all duration-200 ${
                    isEditing
                      ? "bg-[#1F1F1F] border border-[#6200EE]/30 text-white placeholder-gray-600 focus:border-[#6200EE] focus:ring-2 focus:ring-[#6200EE]/15"
            ...
            <div>
              ...
              <select
                ...
                className={`w-full rounded-xl px-4 py-3 text-sm outline-none transition-all duration-200 appearance-none ${
                  isEditing
                    ? "bg-[#1F1F1F] border border-[#6200EE]/30 text-white focus:border-[#6200EE] focus:ring-2 focus:ring-[#6200EE]/15"
                    : "bg-[#222222] border border-white/5 text-gray-300 cursor-default"
                }`}
              >
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-0.5 h-5 rounded-full bg-gradient-to-b from-[#00FFC2] to-[#6200EE]" />
        ...
        {/* Edit mode hint */}
        {isEditing && (
          <div className="flex items-center gap-3 px-4 py-3.5 rounded-xl bg-[#6200EE]/8 border border-[#6200EE]/15">
            <div className="w-2 h-2 rounded-full bg-[#6200EE] animate-pulse shrink-0" />
            <p className="text-xs text-gray-400">
              You&apos;re in edit mode — click{" "}
              <span className="text-[#00FFC2] font-semibold">Save Changes</span> to apply your updates.
            </p>
          </div>
        )}
      </div>
